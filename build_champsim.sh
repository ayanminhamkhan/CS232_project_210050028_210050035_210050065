...
# ICLUSIVITY=$8       # inclusivity = 0 ==> inclusive, 1 ==> non-inclusive, 2 ==> exclusive

# cache="./src/cache.cc"
# cache_0="./src/cache_inc.txt"
# cache_1="./src/cache_noninc.txt"
# cache_2="./src/cache_exc.txt"


# #### changing cache based on inclusivity

# if [$INCLUSIVITY -eq 0 ]; then
#     cat $cache_0 > $cache
# elif [$INCLUSIVITY -eq 1]; then
#     cat $cache_1 > $cache
# elif [$INCLUSIVITY -eq 2]; then 
#     cat $cache_2 > $cache
